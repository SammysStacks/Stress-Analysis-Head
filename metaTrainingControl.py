...
if __name__ == "__main__":
    ...
    trainingDate = "2025-02-20"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--angularShiftingPercent', type=float, default=50, help='The percentage of the angular shift.')
