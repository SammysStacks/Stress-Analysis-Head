...
if __name__ == "__main__":
    ...
    trainingDate = "2025-03-16 -2"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--numSpecificDecompositions', type=int, default=2, help='The number of decompositions to use: [1, 2]')
    ...
    parser.add_argument('--profileLR', type=float, default=0.007, help='The learning rate of the health model.')
