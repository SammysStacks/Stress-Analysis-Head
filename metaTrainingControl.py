...
if __name__ == "__main__":
    ...
    trainingDate = "2024-11-21"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--goldenRatio', type=int, default=1
                        , help='The ratio of shared:specific layers (with an extra specific at the end).')
