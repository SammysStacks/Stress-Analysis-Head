...
if __name__ == "__main__":
    ...
    trainingDate = "2025-01-25"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--cullingEpoch', type=int, default=30, help='The number of epochs before culling null weights.')
