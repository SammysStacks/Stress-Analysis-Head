...
if __name__ == "__main__":
    ...
    trainingDate = "2024-12-01 2"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--physioLR', type=float, default=0.2, help='The number of experiments to run.')
