...
if __name__ == "__main__":
    ...
    trainingDate = "2024-11-27 16"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--numSharedEncoderLayers', type=int, default=16, help='The number of layers in the model.')
