...
if __name__ == "__main__":
    ...
    parser.add_argument('--learningRate', type=float, default=0.05, help='The learning rate of the model.')  # Higher values converge faster; Lower values create stable convergence.
