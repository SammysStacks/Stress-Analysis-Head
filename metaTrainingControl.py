...
if __name__ == "__main__":
    ...
    trainingDate = "2024-12-14 RAND-1-10 FNN-2 CNN-4"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--numProfileEpochs', type=int, default=5, help='The epochs for profile training.')
