...
if __name__ == "__main__":
    ...
    parser.add_argument('--angularThreshold', type=float, default=0.1, help='The minimum rotational threshold in degrees.')
    parser.add_argument('--cullingEpoch', type=int, default=10, help='The number of epochs before culling null weights.')
