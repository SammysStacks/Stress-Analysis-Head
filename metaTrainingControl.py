...
if __name__ == "__main__":
    ...
    trainingDate = "2025-03-03"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--profileLR', type=float, default=0.06, help='The learning rate of the health model.')
    ...
    for epoch in range(1, numEpochs + 1):
        ...
        if 2 <= epoch: trainingProtocols.boundAngularWeights(allMetaModels, allModels, applyMaxThresholding=applyMaxThresholding)
