...
if __name__ == "__main__":
    ...
    trainingDate = "2025-02-03"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--angularThresholdMin', type=float, default=6.25, help='The minimum rotational threshold in degrees.')
