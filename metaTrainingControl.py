...
if __name__ == "__main__":
    ...
    trainingDate = "2024-12-02 0-05"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--physioLR', type=float, default=0.1, help='The number of experiments to run.')
