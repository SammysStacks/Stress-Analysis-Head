...
if __name__ == "__main__":
    ...
    trainingDate = "2024-12-20"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--profileLR', type=float, default=0.025, help='The learning rate of the physiological model.')
    ...
    parser.add_argument('--profileWD', type=float, default=1e-4, help='The learning rate of the general model: [1e-2, 1e-4]')
