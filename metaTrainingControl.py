...
if __name__ == "__main__":
    ...
    parser.add_argument('--numActivityModelLayers', type=int, default=21, help='The number of layers in the activity model')
    parser.add_argument('--numEmotionModelLayers', type=int, default=21, help='The number of layers in the emotion model')
