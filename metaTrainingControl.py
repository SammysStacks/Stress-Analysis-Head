...
if __name__ == "__main__":
    ...
    trainingDate = "2025-02-01"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--numSpecificEncoderLayers', type=int, default=4, help='The number of layers in the model: [1, 2]')
    ...
    parser.add_argument('--cullingEpoch', type=int, default=3, help='The number of epochs before culling null weights.')
