...
if __name__ == "__main__":
    ...
    trainingDate = "2024-11-26"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--numSharedEncoderLayers', type=int, default=10, help='The number of layers in the model.')
    ...
    parser.add_argument('--maxWaveletDecompositions', type=int, default=4, help='The maximum number of wavelet decompositions.')
