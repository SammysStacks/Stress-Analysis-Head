...
if __name__ == "__main__":
    ...
    trainingDate = "2025-03-13"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--minAngularThreshold', type=float, default=0.075, help='The smaller rotational threshold in degrees.')
    ...
    parser.add_argument('--profileLR', type=float, default=0.02, help='The learning rate of the health model.')
