...
if __name__ == "__main__":
    ...
    accelerator = accelerate.Accelerator(
        ...
        mixed_precision="no",  # FP32 = "no", BF16 = "bf16", FP16 = "fp16", FP8 = "fp8"  TODO
    )

    # General model parameters.
    trainingDate = "2024-12-18"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--uniformWeightLimits', type=float, default=0.25, help='The limits for profile initialization.')
    ...
    parser.add_argument('--profileLR', type=float, default=0.075, help='The learning rate of the physiological model.')
