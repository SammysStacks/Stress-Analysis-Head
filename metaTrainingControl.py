...
if __name__ == "__main__":
    ...
    trainingDate = "2024-12-31 with non-linearity"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--initialProfileAmp', type=float, default=0.005, help='The limits for profile initialization, [0.005, 0.05]')
    ...
    parser.add_argument('--numProfileShots', type=int, default=20, help='The epochs for profile training.')
