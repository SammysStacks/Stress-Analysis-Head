...
numSharedEncoderLayers_arr=(7 5 3)  # [4, 10]; Best: 6 and 8
                                                            ...
                                                            do
                                                                ...
                                                                do
                                                                    ...
                                                                    do
                                                                        ...
                                                                        filename="signalEncoder_numSharedEncoderLayers_${numSharedEncoderLayers}_numSpecificEncoderLayers_${numSpecificEncoderLayers}_encodedDimension_${encodedDimension}_numProfileShots_${numProfileShots}_wavelet_${waveletType}_optimizer_${optimizer}_lrProfile_${lr_profile}_lrReversible_${lr_reversible}_lrProfileGen_${lr_profileGen}_profileDim_${profileDimension}_minAngleThresh_${minAngularThreshold}_maxAngleThresh_${maxAngularThreshold}_maxParamsKeeping_${maxNumParamsKeeping}_finalMinAngleThresh_${finalMinAngularThreshold}_profileWD_${profileWD}"
