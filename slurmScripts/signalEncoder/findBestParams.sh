...
# Learning parameters.
lrs_profile=(0.01 0.025 0.05)  # 0.005 <= x <= 0.075
lrs_profileGen=('1e-4') # x <= 1e-4;
lrs_reversible=('4e-4' '1e-3')  # 1e-4 <= x == 1e-3 -> [2.5e-4, 5e-4]
...
# Wavelet states.
numSpecificDecompositions_arr=(2 3)
waveletTypes_arr=('bior3.1' 'bior3.3' 'bior3.5' 'bior3.7')
minWaveletDims=(128 64)   ########
