...
# Angular reference states.
minAngularThresholds=('0.05' '0.1' '0.01')
  ...
  do
    ...
    do
      ...
      do
        ...
        do
          for minNumParameters in "${minNumParameters_arr[@]}"
          do
