...
class bvpProtocol(globalProtocol):
    ...
    def extractFeatures(self, timepoints, data):
        ...
        # plt.plot(timepoints, self.normalizeMinMax(standardized_data), 'k', linewidth=2, alpha=1)
        # plt.plot(timepoints, self.normalizeMinMax(first_derivative), 'tab:red', linewidth=1.5, alpha=0.75)
        # plt.plot(timepoints, self.normalizeMinMax(second_derivative), 'tab:blue', linewidth=1.5, alpha=0.75)
        # plt.plot(timepoints, np.zeros_like(timepoints), 'tab:red', linewidth=1.5, alpha=0.75)
        # plt.show()
