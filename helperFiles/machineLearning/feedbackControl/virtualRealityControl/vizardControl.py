...
class virtualWorld:
    ...
    def __init__(self, virtualFileInd = 0, usingHeadset = False):
        ...
        self.virtualDisplay = None              # The parent node of the scene. This should represent the current virtual enviroment.
        self.virtualEnviroments = ["piazza.osgb", "gallery.osgb", "pit.osgb", "maze.osgb", "dojo.osgb"]
        ...
        #viz.MainView.setBuffered(False)        # This sets the main view to render directly to the VR headset, rather than rendering to a buffer and then displaying on the screen.
...
class controlReality(virtualWorld):
    ...
    def __init__(self, virtualFileInd = 0, usingHeadset = False):
        ...
        # Orient the user in the enviroment.
        self.setPosition(x = 0, y = 1.7, z = 0)                  # Set the horizontal, vertical, and depth (x,y,z) coordinates of the user.
        
        # Display the virtual enviroment.
        self.displayEnviroment(virtualFileInd = 0)
    ...
    def setPosition(self, x = 0, y = 1.8, z = 0):
...
if __name__ == "__main__":
    ...
    vizact.onkeydown('0',controlVR.displayEnviroment, 0)
    vizact.onkeydown('1',controlVR.displayEnviroment, 1)
    vizact.onkeydown('2',controlVR.displayEnviroment, 2)
    vizact.onkeydown('3',controlVR.displayEnviroment, 3)
    vizact.onkeydown('4',controlVR.displayEnviroment, 4)
    #vizact.onkeydown('5',controlVR.displayEnviroment, 5)
    
    controlVR.displayEnviroment(0)
