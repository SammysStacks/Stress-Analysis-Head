...
if __name__ == "__main__":
    ...
    left_sound = "name1.wav"  # file names
    right_sound = "name2.wav"  # file names

    generator = binauralBeatsAdjustment(
        base_frequency_choice=None,
        brain_wave_states_choices=None,
        left_sound_name='name1.wav',
        right_sound_name='name2.wav',
        path_to_wave_files=wave_samples_dir
    )

    base_freq_name = 'sacral'  # Base frequency name
    brain_wave_state_harmonics = ['high-alpha']  # Multiple brain wave state harmonics
