...
class generalAutoencoderBase(_autoencoderModules.autoencoderModules):
    def __init__(self, accelerator = None):
        super(generalAutoencoderBase, self).__init__(accelerator, compressionFactor = 1.5, expansionFactor = 1.5)        
    ...
    def signalEncodingModule_preprocess(self, inChannel = 1, channelIncrease = 4):
        ...
        return nn.Sequential(
            ...
            # Convolution architecture: feature engineering
            self.convolutionalThreeFiltersBlock(numChannels = [inChannel, inChannel, inChannel, inChannel], kernel_sizes = [3, 3, 3], dilations = [1, 1, 1], groups = [1, 1, 1]),
        )
    ...
    def ladderModules(self, inChannel = 1, channelIncrease = 4):    
        ...
        return nn.Sequential( 
            ...
            # Convolution architecture: signal-specific feature engineering
            self.convolutionalThreeFilters_noActivationResNetBlock(numChannels = [inChannel, numExpandedChannels, numExpandedChannels, inChannel], kernel_sizes = [3, 3, 3], dilations = [1, 1, 1], groups = [1, 1, 1]),
    ...
    def compressionAlgorithm(self, expandedData, nextSequenceLength, initialSequenceLength): 
        ...
        processedData = self.raisingOperator(expandedData, initialSequenceLength) # Accounts for tome dilation
