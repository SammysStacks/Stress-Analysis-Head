...
class sharedActivityModel(neuralOperatorInterface):
    ...
    def __init__(self, encodedDimension, numLayers, neuralOperatorParameters):
        super(sharedActivityModel, self).__init__(operatorType='fourier', sequenceLength=encodedDimension, numLayers=numLayers, numInputSignals=1, numOutputSignals=1, addBiasTerm=False)
