...
class sharedEmotionModel(neuralOperatorInterface):
    ...
    def __init__(self, operatorType, encodedDimension, numLayers, neuralOperatorParameters):
        super(sharedEmotionModel, self).__init__(operatorType=operatorType, sequenceLength=encodedDimension, numLayers=numLayers, numInputSignals=1, numOutputSignals=1, addBiasTerm=False)
