...
class organizeTrainingLosses(lossCalculations):
    ...
    def storeTrainingLosses(self, submodel, modelPipeline, lossDataLoader):
        ...
        with torch.no_grad():
            ...
            missingDataMask, reconstructedSignalData, generalEncodingLoss, physiologicalProfile, activityProfile, basicEmotionProfile, emotionProfile = model.fullPass(submodel, allSignalData, allSignalIdentifiers, allMetadata, device=model.device, trainingFlag=False)
