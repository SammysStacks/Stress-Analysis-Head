...
class organizeTrainingLosses(lossCalculations):
    ...
    def storeTrainingLosses(self, submodel, modelPipeline, lossDataLoader):
        ...
        with torch.no_grad():
            ...
            validDataMask, reconstructedSignalData, resampledSignalData, physiologicalProfile, activityProfile, basicEmotionProfile, emotionProfile = model.fullPass(submodel, allSignalData, allSignalIdentifiers, allMetadata, device=self.accelerator.device, onlyProfileTraining=False)
