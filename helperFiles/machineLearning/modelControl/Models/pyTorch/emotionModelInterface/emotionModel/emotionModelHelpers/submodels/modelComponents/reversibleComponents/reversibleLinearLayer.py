...
class reversibleLinearLayer(reversibleInterface):
    ...
    def __init__(self, numSignals, sequenceLength, kernelSize, numLayers, activationMethod):
        ...
        self.gradientScale = 0.2  # The scaling factor for the gradients.
    ...
    def applyLayer(self, inputData, layerInd):
        ...
        if self.kernelSize != self.sequenceLength: neuralWeights = self.restrictedWindowMask * neuralWeights + self.stabilityTerm*0.925
