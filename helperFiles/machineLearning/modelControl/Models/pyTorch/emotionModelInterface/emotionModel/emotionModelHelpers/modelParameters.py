...
class modelParameters:
    ...
    def getTrainingBatchSize(self, submodel, numExperiments, datasetName):
        ...
        if datasetName == modelConstants.wesadDatasetName: effectiveMinBatchSize = 32
    ...
    @staticmethod
    def getEpochInfo(): return 150, 10, 50  # numEpochs, numEpoch_toPlot, numEpoch_toSaveFull

    @staticmethod
    def getProfileEpochs(): return modelConstants.userInputParams['numProfileEpochs']  # numEpochs

    @staticmethod
    def getEpochWarmups(): return 6
