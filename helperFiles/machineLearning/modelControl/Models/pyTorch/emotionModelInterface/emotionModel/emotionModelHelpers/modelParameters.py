...
class modelParameters:
    ...
    def getExclusionSequenceCriteria(submodel):
        if submodel == modelConstants.signalEncoderModel: return 20, 20, 3, 0.5, 0.25  # minSequencePoints, minSignalPresentCount, minBoundaryPoints, maxSinglePointDiff, maxAverageDiff
        elif submodel == modelConstants.emotionModel: return 20, 20, 3, 0.5, 0.25  # minSequencePoints, minSignalPresentCount, minBoundaryPoints, maxSinglePointDiff, maxAverageDiff
        else: raise Exception()
