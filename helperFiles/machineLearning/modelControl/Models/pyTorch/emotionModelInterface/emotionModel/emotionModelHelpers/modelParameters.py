...
class modelParameters:
    ...
    def embedInformation(submodel, trainingDate, validationRun):
        ...
        signalEncoderModelInfo = (f"signalEncoder{' validation' if validationRun else ''} shared-{userInputParams['numIgnoredSharedHF']} thresh{userInputParams['minAngularThreshold']}-{userInputParams['minThresholdStep']}-{userInputParams['maxAngularThreshold']} {userInputParams['optimizerType']} {userInputParams['numLayers']}-shared specific-{userInputParams['numLayers']} " +
