...
class neuralOperatorInterface(emotionModelWeights):
    ...
    def initializeWaveletLayer(self, sequenceLength, neuralOperatorParameters, reversibleFlag):
        ...
        numDecompositions = waveletNeuralOperatorLayer.max_decompositions(signal_length=sequenceLength, wavelet_name=waveletType, minSignalLength=32)  # Number of decompositions for the waveletType transform.
