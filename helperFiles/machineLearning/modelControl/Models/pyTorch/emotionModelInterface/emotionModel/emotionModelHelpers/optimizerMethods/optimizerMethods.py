...
class optimizerMethods:
    ...
    def getModelParams(self, submodel, model):
        modelParams = [
            ...
            {'params': model.inferenceModel.parameters(), 'weight_decay': 1, 'lr': self.userInputParams['physioLR']},
            {'params': model.sharedSignalEncoderModel.parameters(), 'weight_decay': 1e-3, 'lr': self.userInputParams['sharedLR']},  # 0.1 - 0.001
            ...
            {'params': model.specificSignalEncoderModel.profileModel.parameters(), 'weight_decay': 1, 'lr': self.userInputParams['physioLR']},  # 0.1 - 0.01
        ]
