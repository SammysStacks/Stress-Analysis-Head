...
class optimizerMethods:
    ...
    def addOptimizer(self, submodel, model):
        ...
        if submodel == modelConstants.emotionModel: angularWD, angularLR = angularWD/100, angularLR/10
        ...
        modelParams = [
            ...
            {'params': (param for name, param in model.named_parameters() if "basicEmotionWeights" in name), 'weight_decay': 1e-4, 'lr': 1e-3},
