...
class optimizerMethods:
    ...
    def getModelParams(submodel, model):
        modelParams = [
            ...
            {'params': model.inferenceModel.parameters(), 'weight_decay': 1e-3, 'lr': 1},
            {'params': model.sharedSignalEncoderModel.parameters(), 'weight_decay': 1e-3, 'lr': 1},
            {'params': model.specificSignalEncoderModel.parameters(), 'weight_decay': 1e-3, 'lr': 1},
        ]
