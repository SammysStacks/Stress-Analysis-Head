...
class optimizerMethods:
    ...
    def getModelParams(self, submodel, model):
        modelParams = [
            ...
            {'params': model.inferenceModel.parameters(), 'weight_decay': 1e-4, 'lr': 0.1},
            {'params': model.sharedSignalEncoderModel.parameters(), 'weight_decay': 1e-4, 'lr': self.userInputParams['generalLR']},  # 0.1 - 0.001
