...
class optimizerMethods:
    ...
    def getLearningRateScheduler(optimizer):
        ...
        return CosineAnnealingLR_customized(optimizer=optimizer,  T_max=1, absolute_min_lr=1e-5, multiplicativeFactor=10, numWarmupEpochs=modelConstants.numEpochsd_minLR, warmupFactor=2, last_epoch=-1)
