...
class optimizerMethods:
    ...
    def getModelParams(submodel, model):
        modelParams = [
            ...
            {'params': model.inferenceModel.parameters(), 'weight_decay': 1e-3, 'lr': 1E-3},
            {'params': model.sharedSignalEncoderModel.parameters(), 'weight_decay': 1e-3, 'lr': 1E-3},
            {'params': model.specificSignalEncoderModel.parameters(), 'weight_decay': 1e-3, 'lr': 1E-3},
        ]
    ...
    def addOptimizer(self, submodel, model):
        ...
        optimizer = self.setOptimizer(modelParams, lr=1E-3, weight_decay=1e-3, optimizerType=self.userInputParams["optimizerType"])
