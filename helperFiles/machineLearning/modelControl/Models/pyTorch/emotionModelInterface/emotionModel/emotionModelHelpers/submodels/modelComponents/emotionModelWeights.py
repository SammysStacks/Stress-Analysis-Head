...
class emotionModelWeights(convolutionalHelpers):
    ...
    def physiologicalGeneration(self, numOutputFeatures):
        ...
        self.convolutionalFilters_resNetBlocks(numResNets=1, numBlocks=2, numChannels=[1, 1], kernel_sizes=3, dilations=1, groups=1, strides=1, convType='conv1D', activationMethod="SoftSign", numLayers=None, addBias=False),
