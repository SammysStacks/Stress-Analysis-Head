...
class commonFeatureExtraction(featureExtractionModules):
    def __init__(self, numEncodedSignals=32, compressedLength=64):
        ...
        self.extractSignalFeatures = self.commonSignalFeatureExtraction(inChannel=1, signalLength=compressedLength)
        self.reduceChannelSignals = self.commonChannelFeatureExtraction(inChannel=numEncodedSignals, outChannel=8, signalLength=compressedLength)
    ...
    def forward(self, inputData):
        ...
        assert compressedLength == self.compressedLength, f"Expected signal dimension of {self.compressedLength}, but got {compressedLength}."
