            ...
            if self.accelerator.is_local_main_process:
                ...
                if submodel == modelConstants.signalEncoderModel:
                    ...
                    if not showMinimumPlots:
                        ...
                        self.signalEncoderViz.plotProfilePath(initialSignalData=signalData, relativeTimes=resampledBiomarkerTimes, retrainingProfilePath=backwardModelPassSignals, batchInd=batchInd, signalNames=signalNames, epoch=currentEpoch, saveFigureLocation="SignalEncoderModel/", plotTitle="Backwards transformations (HP to feature)")
                        self.signalEncoderViz.modelFlow(initialSignalData=signalData, dataTimes=resampledBiomarkerTimes, dataStatesAll=backwardModelPassSignals, batchInd=batchInd, signalNames=signalNames, epoch=currentEpoch, saveFigureLocation="SignalEncoderModel/", plotTitle="Signal transformations by layer 3D")
                        self.signalEncoderViz.plotSignalEncodingStatePath(initialSignalData=signalData, relativeTimes=resampledBiomarkerTimes, compiledSignalEncoderLayerStates=backwardModelPassSignals, batchInd=batchInd, signalNames=signalNames, epoch=currentEpoch, saveFigureLocation="SignalEncoderModel/", plotTitle="Signal transformations by layer heatmap")
