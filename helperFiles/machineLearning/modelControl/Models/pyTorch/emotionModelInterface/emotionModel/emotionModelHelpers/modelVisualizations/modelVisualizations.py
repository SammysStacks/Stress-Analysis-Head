        ...
        with torch.no_grad():
            ...
            if self.accelerator.is_local_main_process:
                ...
                if submodel == modelConstants.signalEncoderModel:
                    ...
                    self.signalEncoderViz.modelPropagation3D(jacobianFullPassPath=np.angle(jacobianFullPassPath, deg=False), epoch=currentEpoch, saveFigureLocation="signalEncoding/", plotTitle="3D Angles Path", batchInd=0, signalInd=0)
