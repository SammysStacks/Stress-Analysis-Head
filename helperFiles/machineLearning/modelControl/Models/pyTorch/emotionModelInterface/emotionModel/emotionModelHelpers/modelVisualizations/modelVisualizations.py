        ...
        with torch.no_grad():
            ...
            if self.accelerator.is_local_main_process:
                ...
                if submodel == modelConstants.signalEncoderModel:
                    ...
                    self.signalEncoderViz.plotProfileReconstruction(resampledBiomarkerTimes, healthProfile, reconstructedPhysiologicalProfile, epoch=currentEpoch, saveFigureLocation="signalEncoding/", plotTitle="Physiological Reconstruction")
                    self.signalEncoderViz.plotProfileReconstructionError(resampledBiomarkerTimes, healthProfile, reconstructedPhysiologicalProfile, epoch=currentEpoch, saveFigureLocation="signalEncoding/", plotTitle="Physiological Reconstruction Error")
                    ...
                    self.signalEncoderViz.plotSignalEncodingStatePath(relativeTimes=None, compiledSignalEncoderLayerStates=np.expand_dims(jacobianSpatialPath, axis=1), epoch=currentEpoch, hiddenLayers=0, saveFigureLocation="signalEncoding/", plotTitle="Jacobian Spatial Flow")
                    self.signalEncoderViz.plotSignalEncodingStatePath(relativeTimes=None, compiledSignalEncoderLayerStates=np.expand_dims(jacobianNeuralPath, axis=1), epoch=currentEpoch, hiddenLayers=0, saveFigureLocation="signalEncoding/", plotTitle="Jacobian Neural Flow")
