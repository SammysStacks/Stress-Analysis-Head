        ...
        with torch.no_grad():
            ...
            if self.accelerator.is_local_main_process:
                ...
                if submodel == modelConstants.signalEncoderModel:
                    ...
                    self.signalEncoderViz.plotSignalEncodingStatePath(relativeTimes=None, compiledSignalEncoderLayerStates=jacobianFullPassPath, epoch=currentEpoch, saveFigureLocation="signalEncoding/", plotTitle="Jacobian Flow")
