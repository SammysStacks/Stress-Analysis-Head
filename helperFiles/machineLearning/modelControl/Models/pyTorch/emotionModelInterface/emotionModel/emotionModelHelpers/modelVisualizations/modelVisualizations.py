    ...
    def plotDatasetComparison(self, submodel, allModelPipelines, trainingDate):
        ...
        with torch.no_grad():
            if self.accelerator.is_local_main_process:
                ...
                self.generalViz.plotSinglaParameterFlow(trainingValues=activationParamsPaths[:, :, 0, 0, 0], saveFigureLocation="trainingLosses/", plotTitle="Signal Encoder Infinite Bound Activations")
                self.generalViz.plotSinglaParameterFlow(trainingValues=activationParamsPaths[:, :, 1, 0, 0], saveFigureLocation="trainingLosses/", plotTitle="Signal Encoder Linearity Activations")
