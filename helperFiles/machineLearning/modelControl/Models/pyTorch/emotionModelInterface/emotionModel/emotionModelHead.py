...
class emotionModelHead(nn.Module):
    ...
    def getJacobianFullPassPath(self, device):
        ...
        # jacobianFullPassPath: 2 * numSpecificEncoderLayers + numSharedEncoderLayers, numLayers=1, numModelLayers, encodedDimension  TODO: collect for every profile epoch? Memory?
