...
class compileModelInfo:
    ...
    def getUserInputParameters(self):
        ...
        userInputParams = {'submodel': 'signalEncoderModel', 'optimizerType': 'AdamW', 'reversibleLearningProtocol': 'rCNN', 'irreversibleLearningProtocol': 'FC', 'deviceListed': 'cpu', 'numSpecificEncoderLayers': 1, 'numSharedEncoderLayers': 8,
