...
class compileModelInfo:
    ...
    def getUserInputParameters(self):
        ...
        userInputParams = {'submodel': 'signalEncoderModel', 'optimizerType': 'AdamW', 'learningProtocol': 'reversibleLieLayer', 'learningProtocol': 'FC', 'deviceListed': 'cpu', 'numSpecificEncoderLayers': 1, 'numSharedEncoderLayers': 8,
