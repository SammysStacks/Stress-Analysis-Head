...
class compileModelDataHelpers:
    ...
    def embedInformation(submodel, userInputParams, trainingDate):
        ...
        userInputParams['profileLR'] = userInputParams['uniformWeightLimit']   # TODO AFHHHHHHHHHHHHHHH
        signalEncoderModelInfo = f"signalEncoder on {userInputParams['deviceListed']} {userInputParams['optimizerType']} shared-specific{userInputParams['numSharedEncoderLayers']}-{userInputParams['numSpecificEncoderLayers']} pEpochs{userInputParams['numProfileEpochs']} encodedDim{userInputParams['encodedDimension']} opt{userInputParams['beta1']}-{userInputParams['beta2']}-{userInputParams['momentum_decay']} LR-G{userInputParams['physGenLR']}-R{userInputParams['reversibleLR']}-P{userInputParams['profileLR']} WD-G{userInputParams['physGenWD']}-R{userInputParams['reversibleWD']}-P{userInputParams['profileWD']} pParams{userInputParams['numEncodedWeights']} weightLim{userInputParams['uniformWeightLimit']} {userInputParams['neuralOperatorParameters']['wavelet']['waveletType']}"
