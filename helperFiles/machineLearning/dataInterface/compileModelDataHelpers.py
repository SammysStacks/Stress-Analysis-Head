...
class compileModelDataHelpers:
    ...
    def embedInformation(submodel, userInputParams, trainingDate):
        ...
        signalEncoderModelInfo = f"signalEncoder on {userInputParams['deviceListed']} {userInputParams['optimizerType']} sharedLayers{userInputParams['numSharedEncoderLayers']} specificLayers{userInputParams['numSpecificEncoderLayers']} encodedDim{userInputParams['encodedDimension']} LR-S-{userInputParams['sharedLR']}-G{userInputParams['generalLR']}-P{userInputParams['physioLR']} numPParams{userInputParams['numEncodedWeights']} {userInputParams['neuralOperatorParameters']['wavelet']['waveletType']}"
