...
class compileModelDataHelpers:
    ...
    def embedInformation(submodel, userInputParams, trainingDate):
        ...
        signalEncoderModelInfo = f"signalEncoder on {userInputParams['deviceListed']} {userInputParams['optimizerType']} shared-specific{userInputParams['numSharedEncoderLayers']}-{userInputParams['numSpecificEncoderLayers']} pEpochs{userInputParams['numProfileEpochs']} encodedDim{userInputParams['encodedDimension']} LR-G{userInputParams['physGenLR']}-R{userInputParams['reversibleLR']}-P{userInputParams['profileLR']} WD-G{userInputParams['physGenWD']}-R{userInputParams['reversibleWD']}-P{userInputParams['profileWD']} opt{userInputParams['beta1']}-{userInputParams['beta2']}-{userInputParams['momentum_decay']} pParams{userInputParams['numEncodedWeights']} weightLim{userInputParams['uniformWeightLimits']} {userInputParams['neuralOperatorParameters']['wavelet']['waveletType']}"
