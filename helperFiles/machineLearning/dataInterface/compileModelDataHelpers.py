...
class compileModelDataHelpers:
    ...
    def embedInformation(submodel, userInputParams, trainingDate):
        ...
        signalEncoderModelInfo = f"signalEncoder on {userInputParams['deviceListed']} {userInputParams['optimizerType']} pEpochs{userInputParams['numProfileEpochs']} sharedLayers{userInputParams['numSharedEncoderLayers']} specificLayers{userInputParams['numSpecificEncoderLayers']} encodedDim{userInputParams['encodedDimension']} LR-G{userInputParams['physGenLR']}-R{userInputParams['reversibleLR']}-P{userInputParams['profileLR']} WD-G{userInputParams['physGenWD']}-R{userInputParams['reversibleWD']}-P{userInputParams['profileWD']} opt{userInputParams['beta1']}-{userInputParams['beta2']}-{userInputParams['momentum_decay']} numPParams{userInputParams['numEncodedWeights']} weightLim{userInputParams['uniformWeightLimits']} {userInputParams['neuralOperatorParameters']['wavelet']['waveletType']}"
