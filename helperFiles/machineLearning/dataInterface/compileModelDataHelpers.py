...
class compileModelDataHelpers:
    ...
    def _preprocessSignals(self, allSignalData, featureNames, metadatasetName):
        ...
        for _ in range(4):
            ...
            else: badSinglePointMaxDiff = 3/4 < biomarkerData.diff(dim=-1).abs()  # Maximum difference between consecutive points: batchSize, numSignals, maxSequenceLength-1
        ...
        else: averageDiff = biomarkerDiffs.nanmean(dim=-1) < 3/4  # Average difference between consecutive points: batchSize, numSignals
