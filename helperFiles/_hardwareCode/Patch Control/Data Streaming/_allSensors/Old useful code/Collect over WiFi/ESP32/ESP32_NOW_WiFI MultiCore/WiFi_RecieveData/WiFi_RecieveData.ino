...
void compileAndSendData(const uint8_t *incomingData) {
    sprintf(finalMessage, "%s.%s%s%s,%s.%s%s,%s%s,%s%s%s,%s%s", 
        decompressByte(incomingData[0]),
        decompressByte(incomingData[1]), decompressByte(incomingData[2]), decompressByte(incomingData[3]),
        decompressByte(incomingData[4]),
        decompressByte(incomingData[5]), decompressByte(incomingData[6]),
        decompressByte(incomingData[7]), decompressByte(incomingData[8]),
        decompressByte(incomingData[9]), decompressByte(incomingData[10]), decompressByte(incomingData[11]),
        decompressByte(incomingData[12]), decompressByte(incomingData[13])
    );
