class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f64[12, 6, 256]", primals_2: "f64[]", primals_3: "f64[]"):
        ...
        mul_3: "f32[256]" = torch.ops.aten.mul.Tensor(mul_2, primals_2);  mul_2 = None
        add_1: "f32[256]" = torch.ops.aten.add.Tensor(mul_3, primals_3);  mul_3 = None
        ...
        div: "f64[12, 6, 256]" = torch.ops.aten.div.Tensor(primals_1, sub);  primals_1 = sub = None
