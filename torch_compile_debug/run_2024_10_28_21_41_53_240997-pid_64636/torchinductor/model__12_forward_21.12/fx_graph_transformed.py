class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f64[12, 6, 256]", primals_2: "f64[1, 129, 129]", primals_3: "f64[6, 129, 129]", primals_4: "f64[6, 129, 129]", primals_5: "f64[]", primals_6: "f64[]", primals_7: "f64[]", primals_8: "f64[]", primals_9: "f64[6, 129, 129]", primals_10: "f64[6, 129, 129]", primals_11: "f64[]", primals_12: "f64[]", primals_13: "f64[]", primals_14: "f64[]", primals_15: "f64[6, 129, 129]", primals_16: "f64[6, 129, 129]", primals_17: "f64[]", primals_18: "f64[]", primals_19: "f64[]", primals_20: "f64[]", primals_21: "f64[]", primals_22: "f64[]"):
        ...
        view: "f64[6, 12, 129]" = torch.ops.aten.reshape.default(permute_2, [6, 12, 129]);  permute_2 = None
        permute_3: "f64[6, 129, 129, 1]" = torch.ops.aten.permute.default(permute_1, [1, 3, 2, 0]);  permute_1 = None
        view_1: "f64[6, 129, 129]" = torch.ops.aten.reshape.default(permute_3, [6, 129, 129]);  permute_3 = None
        bmm: "f64[6, 12, 129]" = torch.ops.aten.bmm.default(view, view_1);  view = None
        view_2: "f64[6, 12, 1, 129]" = torch.ops.aten.reshape.default(bmm, [6, 12, 1, 129]);  bmm = None
        permute_4: "f64[12, 6, 129, 1]" = torch.ops.aten.permute.default(view_2, [1, 0, 3, 2]);  view_2 = None
        view_3: "f64[12, 6, 129]" = torch.ops.aten.reshape.default(permute_4, [12, 6, 129]);  permute_4 = None
        ...
        view_4: "f64[6, 12, 129]" = torch.ops.aten.reshape.default(permute_7, [6, 12, 129]);  permute_7 = None
        permute_8: "f64[6, 129, 129, 1]" = torch.ops.aten.permute.default(permute_6, [1, 3, 2, 0]);  permute_6 = None
        view_5: "f64[6, 129, 129]" = torch.ops.aten.reshape.default(permute_8, [6, 129, 129]);  permute_8 = None
        bmm_1: "f64[6, 12, 129]" = torch.ops.aten.bmm.default(view_4, view_5);  view_4 = None
        view_6: "f64[6, 12, 1, 129]" = torch.ops.aten.reshape.default(bmm_1, [6, 12, 1, 129]);  bmm_1 = None
        permute_9: "f64[12, 6, 129, 1]" = torch.ops.aten.permute.default(view_6, [1, 0, 3, 2]);  view_6 = None
        view_7: "f64[12, 6, 129]" = torch.ops.aten.reshape.default(permute_9, [12, 6, 129]);  permute_9 = None
        ...
        view_8: "f64[6, 12, 129]" = torch.ops.aten.reshape.default(permute_12, [6, 12, 129]);  permute_12 = None
        permute_13: "f64[6, 129, 129, 1]" = torch.ops.aten.permute.default(permute_11, [1, 3, 2, 0]);  permute_11 = None
        view_9: "f64[6, 129, 129]" = torch.ops.aten.reshape.default(permute_13, [6, 129, 129]);  permute_13 = None
        bmm_2: "f64[6, 12, 129]" = torch.ops.aten.bmm.default(view_8, view_9);  view_8 = None
        view_10: "f64[6, 12, 1, 129]" = torch.ops.aten.reshape.default(bmm_2, [6, 12, 1, 129]);  bmm_2 = None
        permute_14: "f64[12, 6, 129, 1]" = torch.ops.aten.permute.default(view_10, [1, 0, 3, 2]);  view_10 = None
        view_11: "f64[12, 6, 129]" = torch.ops.aten.reshape.default(permute_14, [12, 6, 129]);  permute_14 = None
        ...
        mul_33: "i64[256]" = torch.ops.aten.mul.Tensor(iota_6, 1);  iota_6 = None
        add_21: "i64[256]" = torch.ops.aten.add.Tensor(mul_33, 0);  mul_33 = None
        convert_element_type_6: "f32[256]" = torch.ops.prims.convert_element_type.default(add_21, torch.float32);  add_21 = None
        
         # File: C:\Users\sasol.SQUIRTLE\Desktop\userData\Sam\projects\Stress-Analysis-Head\helperFiles\machineLearning\modelControl\Models\pyTorch\emotionModelInterface\emotionModel\emotionModelHelpers\optimizerMethods\activationFunctions.py:236 in getNonLinearity, code: return self.amplitude*(positions*2*torch.pi*self.learnableFrequency + self.learnablePhaseShift).sin().pow(2) + 1 - self.amplitude/2
        mul_34: "f32[256]" = torch.ops.aten.mul.Tensor(convert_element_type_6, 2);  convert_element_type_6 = None
        mul_35: "f32[256]" = torch.ops.aten.mul.Tensor(mul_34, 3.141592653589793);  mul_34 = None
        mul_36: "f32[256]" = torch.ops.aten.mul.Tensor(mul_35, primals_21);  mul_35 = None
        add_22: "f32[256]" = torch.ops.aten.add.Tensor(mul_36, primals_22);  mul_36 = None
        sin_6: "f32[256]" = torch.ops.aten.sin.default(add_22);  add_22 = None
        pow_7: "f32[256]" = torch.ops.aten.pow.Tensor_Scalar(sin_6, 2);  sin_6 = None
        mul_37: "f32[256]" = torch.ops.aten.mul.Tensor(pow_7, 0.1);  pow_7 = None
        add_23: "f32[256]" = torch.ops.aten.add.Tensor(mul_37, 1);  mul_37 = None
        sub_12: "f32[256]" = torch.ops.aten.sub.Tensor(add_23, 0.05);  add_23 = None
        
         # File: C:\Users\sasol.SQUIRTLE\Desktop\userData\Sam\projects\Stress-Analysis-Head\helperFiles\machineLearning\modelControl\Models\pyTorch\emotionModelInterface\emotionModel\emotionModelHelpers\optimizerMethods\activationFunctions.py:231 in inversePass, code: return y / nonLinearityTerm
        div_10: "f64[12, 6, 256]" = torch.ops.aten.div.Tensor(_fft_c2r, sub_12);  _fft_c2r = sub_12 = None
        ...
        return (div_10, primals_2, primals_5, primals_6, primals_7, primals_8, primals_21, primals_22, sub_6, sub_7, sub_10, sub_11, permute_31, permute_35, permute_39, permute_43, permute_47, permute_51)
