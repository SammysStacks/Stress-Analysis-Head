...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22):
        ...
        mul_33 = torch.ops.aten.mul.Tensor(iota_6, 1);  iota_6 = None
        add_21 = torch.ops.aten.add.Tensor(mul_33, 0);  mul_33 = None
        convert_element_type_6 = torch.ops.prims.convert_element_type.default(add_21, torch.float32);  add_21 = None
        mul_34 = torch.ops.aten.mul.Tensor(convert_element_type_6, 2);  convert_element_type_6 = None
        mul_35 = torch.ops.aten.mul.Tensor(mul_34, 3.141592653589793);  mul_34 = None
        mul_36 = torch.ops.aten.mul.Tensor(mul_35, primals_21);  mul_35 = None
        add_22 = torch.ops.aten.add.Tensor(mul_36, primals_22);  mul_36 = None
        sin_6 = torch.ops.aten.sin.default(add_22);  add_22 = None
        pow_7 = torch.ops.aten.pow.Tensor_Scalar(sin_6, 2);  sin_6 = None
        mul_37 = torch.ops.aten.mul.Tensor(pow_7, 0.1);  pow_7 = None
        add_23 = torch.ops.aten.add.Tensor(mul_37, 1);  mul_37 = None
        sub_12 = torch.ops.aten.sub.Tensor(add_23, 0.05);  add_23 = None
        div_10 = torch.ops.aten.div.Tensor(_fft_c2r, sub_12);  _fft_c2r = sub_12 = None
...
def load_args(reader):
    ...
    reader.tensor(buf20, (), dtype=torch.float64, is_leaf=True)  # primals_21
    buf21 = reader.storage(None, 8, device=device(type='cuda', index=0), dtype_hint=torch.float64)
    reader.tensor(buf21, (), dtype=torch.float64, is_leaf=True)  # primals_22
