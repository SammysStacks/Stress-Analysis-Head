class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f64[110, 129, 129]", primals_2: "f64[110, 129, 129]", primals_3: "f64[110, 129, 129]", primals_4: "f64[110, 129, 129]", primals_5: "f64[1, 129, 129]", primals_6: "f64[26, 110, 129]", primals_7: "f64[129, 129]", primals_8: "f64[]", primals_9: "f64[]", primals_10: "f64[]"):
        ...
        view: "f64[110, 26, 129]" = torch.ops.aten.reshape.default(permute_2, [110, 26, 129]);  permute_2 = None
        permute_3: "f64[110, 129, 129, 1]" = torch.ops.aten.permute.default(permute_1, [1, 3, 2, 0]);  permute_1 = None
        view_1: "f64[110, 129, 129]" = torch.ops.aten.reshape.default(permute_3, [110, 129, 129]);  permute_3 = None
        bmm: "f64[110, 26, 129]" = torch.ops.aten.bmm.default(view, view_1)
        view_2: "f64[110, 26, 1, 129]" = torch.ops.aten.reshape.default(bmm, [110, 26, 1, 129]);  bmm = None
        permute_4: "f64[26, 110, 129, 1]" = torch.ops.aten.permute.default(view_2, [1, 0, 3, 2]);  view_2 = None
        view_3: "f64[26, 110, 129]" = torch.ops.aten.reshape.default(permute_4, [26, 110, 129]);  permute_4 = None
        ...
        view_4: "f64[110, 26, 129]" = torch.ops.aten.reshape.default(permute_7, [110, 26, 129]);  permute_7 = None
        permute_8: "f64[110, 129, 129, 1]" = torch.ops.aten.permute.default(permute_6, [1, 3, 2, 0]);  permute_6 = None
        view_5: "f64[110, 129, 129]" = torch.ops.aten.reshape.default(permute_8, [110, 129, 129]);  permute_8 = None
        bmm_1: "f64[110, 26, 129]" = torch.ops.aten.bmm.default(view_4, view_5)
        view_6: "f64[110, 26, 1, 129]" = torch.ops.aten.reshape.default(bmm_1, [110, 26, 1, 129]);  bmm_1 = None
        permute_9: "f64[26, 110, 129, 1]" = torch.ops.aten.permute.default(view_6, [1, 0, 3, 2]);  view_6 = None
        view_7: "f64[26, 110, 129]" = torch.ops.aten.reshape.default(permute_9, [26, 110, 129]);  permute_9 = None
        ...
        view_8: "f64[110, 26, 129]" = torch.ops.aten.reshape.default(permute_12, [110, 26, 129]);  permute_12 = None
        permute_13: "f64[110, 129, 129, 1]" = torch.ops.aten.permute.default(permute_11, [1, 3, 2, 0]);  permute_11 = None
        view_9: "f64[110, 129, 129]" = torch.ops.aten.reshape.default(permute_13, [110, 129, 129]);  permute_13 = None
        bmm_2: "f64[110, 26, 129]" = torch.ops.aten.bmm.default(view_8, view_9)
        view_10: "f64[110, 26, 1, 129]" = torch.ops.aten.reshape.default(bmm_2, [110, 26, 1, 129]);  bmm_2 = None
        permute_14: "f64[26, 110, 129, 1]" = torch.ops.aten.permute.default(view_10, [1, 0, 3, 2]);  view_10 = None
        view_11: "f64[26, 110, 129]" = torch.ops.aten.reshape.default(permute_14, [26, 110, 129]);  permute_14 = None
        ...
        view_12: "f64[110, 26, 129]" = torch.ops.aten.reshape.default(permute_17, [110, 26, 129]);  permute_17 = None
        permute_18: "f64[110, 129, 129, 1]" = torch.ops.aten.permute.default(permute_16, [1, 3, 2, 0]);  permute_16 = None
        view_13: "f64[110, 129, 129]" = torch.ops.aten.reshape.default(permute_18, [110, 129, 129]);  permute_18 = None
        bmm_3: "f64[110, 26, 129]" = torch.ops.aten.bmm.default(view_12, view_13)
        view_14: "f64[110, 26, 1, 129]" = torch.ops.aten.reshape.default(bmm_3, [110, 26, 1, 129]);  bmm_3 = None
        permute_19: "f64[26, 110, 129, 1]" = torch.ops.aten.permute.default(view_14, [1, 0, 3, 2]);  view_14 = None
        view_15: "f64[26, 110, 129]" = torch.ops.aten.reshape.default(permute_19, [26, 110, 129]);  permute_19 = None
