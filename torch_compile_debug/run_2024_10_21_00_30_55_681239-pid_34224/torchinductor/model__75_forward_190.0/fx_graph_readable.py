class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f64[1, 129, 129]", primals_2: "f64[1, 129, 129]", primals_3: "f64[129, 129]", primals_4: "Sym(s0)", primals_5: "f64[s0, 1, 129]"):
        ...
        view: "f64[1, s0, 129]" = torch.ops.aten.view.default(permute_2, [1, primals_4, 129]);  permute_2 = None
        ...
        view_2: "f64[s0, 1, 1, 129]" = torch.ops.aten.view.default(bmm, [primals_4, 1, 1, 129]);  bmm = None
        permute_4: "f64[s0, 1, 129, 1]" = torch.ops.aten.permute.default(view_2, [0, 2, 3, 1]);  view_2 = None
        view_3: "f64[s0, 1, 129]" = torch.ops.aten.view.default(permute_4, [primals_4, 1, 129]);  permute_4 = None
